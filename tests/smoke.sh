...
check_not_contains aui/libs/install.sh 'Use LVM on top of the encrypted root'
check_not_contains aui/libs/install.sh 'setup_lvm "\$\{state\[root_device\]\}" "lvm" "root"'
...
check_contains aui/install 'state\[fstab_type\]="UUID"'
check_contains aui/install 'Generated fstab is missing root mount'
check_contains aui/install 'Generated fstab is missing EFI mount'
check_contains aui/install 'validate_boot_artifacts'
check_contains aui/install 'mkinitcpio HOOKS is missing sd-encrypt'
check_contains aui/install 'mkinitcpio HOOKS is missing lvm2'
check_contains aui/install 'Root account is locked or has no password'
